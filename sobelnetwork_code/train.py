...
from tensorflow.keras.callbacks import Callback, EarlyStopping, LearningRateScheduler, ModelCheckpoint,CSVLog
...
if __name__=="__mian__":
    ...
    model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=params['0.001']),
